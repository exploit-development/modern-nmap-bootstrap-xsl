...
MIT License
 (https://github.com/codesecure-org/)
-->
    ...
    <html lang="en">
      ...
      <body>
        ...
        <footer class="footer">
          <div class="container">
            <p class="text-muted">
              This report was generated with <a href="https://github.com/codesecure-org/modern-nmap-bootstrap-xsl">Modern Nmap Bootstrap XSL</a>.<br/>
              Licensed under <a href="https://en.wikipedia.org/wiki/MIT_License">MIT License</a>.<br/>
              Designed and built by Codesecure (<a href="https://codesecure.org/">https://codesecure.org/</a>).<br/>
            </p>
          </div>
        </footer>
      </body>
